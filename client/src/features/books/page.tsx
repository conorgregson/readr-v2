          ...
          {visibleBooks.length === 0 ? (
            ...
            <div className="space-y-2">
              {visibleBooks.map((b) => {
                ...
                return (
                  <Card key={b.id} className="border-slate-200 bg-white">
                    <div className="flex items-start justify-between gap-3">
                      {/* LEFT SIDE: crossfade view vs. edit */}
                      <div className="content-wrap">
                        {/* View layer */}
                        <div
                          className={`content-layer delay-0 ${
                            showEditUI
                          ...
                          >
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                setDrafts((prev) => ({
                                  ...prev,
                                  [b.id]: { ...draft, author: e.target.value },
                                }))
                              }
                              placeholder="Author (optional)"
                              disabled={interactionLocked}
                        ...
                        {/* Invisible static layer to reserve height (prevents card wobble) */}
                        <div className="content-layer--static opacity-0">
                      ...
                      <div className="controls-wrap">
                        {/* Edit/Delete layer */}
                        <div
                          className={`controls-layer delay-30 ${
                            showEditUI
                              ? "controls-exit pointer-events-none"
                              : "controls-enter"
                          }`}
          ...
          {Object.entries(pendingDeleteById).map(([id, entry]) => (
            ...
            >
              <div className="text-sm">
                Deleted <span className="font-medium">{entry.book.title}</span>
              </div>
              <Button
                type="button"
                variant="secondary"
